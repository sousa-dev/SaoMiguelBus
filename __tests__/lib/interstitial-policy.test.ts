...
describe('evaluateInterstitialPolicy', () => {
  ...
  it('shows subsequent searches at the configured probability', () => {
    const decision = evaluateInterstitialPolicy(
      { ...baseState, hasSearchedThisSession: true },
      1_000_000,
