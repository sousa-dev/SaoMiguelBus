...
Map<String, Icon> icons = {
  ...
  'light_rail_station': const Icon(Icons.directions_bus),
  ...
  'subway_station': const Icon(Icons.directions_bus),
  ...
  'train_station': const Icon(Icons.directions_bus),
  'transit_station': const Icon(Icons.directions_bus),
