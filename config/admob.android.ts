...
export function getAdMobBannerUnitId(): string | null {
  ...
  return env('EXPO_PUBLIC_ADMOB_BANNER_ANDROID') ?? PROD_DEFAULTS.androidBanner;
}
...
export function getAdMobInterstitialUnitId(): string | null {
  ...
  return env('EXPO_PUBLIC_ADMOB_INTERSTITIAL_ANDROID') ?? PROD_DEFAULTS.androidInterstitial;
}
...
export function getAdMobAppOpenUnitId(): string | null {
  ...
  return env('EXPO_PUBLIC_ADMOB_APP_OPEN_ANDROID') ?? PROD_DEFAULTS.androidInterstitial;
}
